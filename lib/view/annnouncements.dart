...
class AnnouncementsView extends NoSliderView {
  final SharedPreferences pref;
  AnnouncementsView({super.key, required this.pref});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(provider.notifier).init(pref).then((_) {
        refresh(ref);
      });
    });
    ...
    return Column(
      children: [
        AppBarBox(
          ...
          text: L10n.of(context)!.announcement,
